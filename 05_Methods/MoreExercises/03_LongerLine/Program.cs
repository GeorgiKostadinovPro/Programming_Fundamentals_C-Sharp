...
namespace _03_LongerLine
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            bool line1Point1IsCloserToZero = PointCloserToZero(x1, y1, x2, y2);
            bool line2Point1IsCloserToZero = PointCloserToZero(x3, y3, x4, y4);
        ...
        private static bool PointCloserToZero(double x1, double y1, double x2, double y2)
        {
